  ...
  return (
    <div className="bg-[url('https://i.ibb.co/mXkzmxC/field.jpg')] bg-cover lg:bg-center bg-bottom min-h-screen">
      <div className="flex flex-col lg:flex-row lg:py-14 lg:px-16">
        <div className="relative w-full lg:w-[80%] bg-white bg-opacity-20 rounded-md h-[86vh] lg:my-5 lg:p-10 lg:bg-[url('https://i.ibb.co/PTdw6sB/pitch.jpg')] bg-cover">
        ...
        {/* ----------------- Right Side ----------------- */}
        <div className='w-full lg:w-[20%] bg-[#202325] border-l-[1px] border-zinc-500 h-[86vh] my-5 text-white'>
